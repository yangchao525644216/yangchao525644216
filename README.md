# Hi there 👋 我是 xiaoheizi

一个对前端开发与开源工具充满热情的开发者。喜欢折腾各种好玩、实用的代码，正在持续探索技术更深处的奥秘。
...
### 🚀 关于我
- 🔭 我目前正在维护 [xhz-cli](https://github.com/yangchao525644216)（脚手架/工具项目）
- 🎯 正在通过刷 LeetCode 提升自己的算法与底层思维
- 💬 欢迎和我交流前端开发、自动化工具、或者任何有趣的开源项目！
